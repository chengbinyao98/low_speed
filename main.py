                ...
                for x in dic_state:
                    ...
                    if x == 1:
                        for num in range(len(dic_state[1])):
                            ...
                            dic_action[1].append([env.cars_posit[dic_state[1][num][0][2]] - env.road_range / 2 + temp * env.beam_section])
                    ...
                    if x == 2:
                        for num in range(len(dic_state[2])):
                            ...
                            b = []
                            for k in range(2):
                                s = temp // int(env.road_range / env.beam_section)  # 商
                                y = temp % int(env.road_range / env.beam_section)  # 余数
                                b = b + [y]
                                temp = s
                            b.reverse()
                            for i in b:
                            ...
                            action = []
                            for dim in range(2):
                                action.append(env.cars_posit[dic_state[2][num][dim][2]] - env.road_range / 2 + add[dim] * env.beam_section)
