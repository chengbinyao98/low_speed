...
class DRAW(object):
    ...
    def piant(self,pos,road_range,ax,frame_slot,n, action):
        ...
        y3 = [2000 for i in range(int(road_range / beam_section))]
        ...
        for j in range(len(pos)):
            ...
            for i in range(road_range):
                ...
                act.append(pos[j] - road_range/2 + i)
                # 直角边
            ...
            for k in range(int(road_range / beam_section)):
                draw_act.append(pos[j] - road_range / 2 + k * beam_section)
            plt.scatter(draw_act,y3)
